...
for(i in 1:3){
  ...
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/top1%/", sample_names[i], ".rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/top1%/", sample_names[i], "_as3A.rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  #assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/top1%/", sample_names[i], "_as3B.rds"))#save the table created for this sample
}
...
for(i in 1:3){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/top10%/", sample_names[i], ".rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/top10%/", sample_names[i], "_as3A.rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  #assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/top10%/", sample_names[i], "_as3B.rds"))#save the table created for this sample
}
```
...
for(i in 1:3){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc//bottom1%/", sample_names[i], ".rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/bottom1%/", sample_names[i], "_as3A.rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  #assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/bottom1%/", sample_names[i], "_as3B.rds"))#save the table created for this sample
}
```
for bottom 10%
```{r}
...
for(i in 1:3){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/bottom10%/", sample_names[i], ".rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/bottom10%/", sample_names[i], "_as3A.rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  #assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins/CHH/1kb/computeted_hpc/bottom10%/", sample_names[i], "_as3B.rds"))#save the table created for this sample
}
```
...
for(i in 1:3){
  ...
  #We are going to filter out the bins that contain less than 3 mapped CG 
  #We are going to filter out the bins that contain less than 5 mapped CG 
  c<-c %>% filter(CG_num>4) #I saved it actidentally as CG but its just C
  c<-c %>% filter(avg_meth>0)
  c<-c %>% filter(!is.na(Purine_num) & !is.na(Pyrimidine_num)) #have at least one from both
  c<- c %>% filter(Purine_num>1 & Pyrimidine_num>1)
  #now create columns with modified methylation
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins_with_strand_information/CHH/1kb/computetd_hpc/top10%/", sample_names[i], ".rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins_with_strand_information/CHH/1kb/computetd_hpc/top10%/", sample_names[i], "_as3A.rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  #assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins_with_strand_information/CHH/1kb/computetd_hpc/top10%/", sample_names[i], "_as3B.rds"))#save the table created for this sample
}
...
for(i in 1:3){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins_with_strand_information/CHH/1kb/computetd_hpc/bottom1%/", sample_names[i], ".rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins_with_strand_information/CHH/1kb/computetd_hpc/bottom1%/", sample_names[i], "_as3A.rds"))#save the table created for this sample
}
...
for(i in 7:7){
  ...
  e<- d %>% filter(rank<=max_rank)
  #assign(sample_names[i], e)
  saveRDS(e,file=paste0("../data/processed/bins_with_strand_information/CHH/1kb/computetd_hpc/bottom1%/", sample_names[i], "_as3B.rds"))#save the table created for this sample
}
```
